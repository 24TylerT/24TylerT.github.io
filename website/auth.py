...
def attempt():
    if request.method == 'POST':
        ...
        new_scout = Scout(team=team, round=round, alliance=alliance, starting_pos=starting_pos, leave_community=leave_community, auton_low_scored=auton_low_scored,auton_low_missed=auton_low_missed,auton_low_unreliable=auton_low_unreliable,
                          auton_mid_scored=auton_mid_scored, auton_mid_missed=auton_mid_missed,auton_mid_unreliable=auton_mid_unreliable, auton_top_scored=auton_top_scored, auton_top_missed=auton_top_missed, auton_top_unreliable=auton_top_unreliable,
                          tele_low_scored=tele_low_scored, tele_low_missed=tele_low_missed, tele_low_unreliable=tele_low_unreliable, tele_mid_scored=tele_mid_scored, tele_mid_missed=tele_mid_missed, tele_mid_unreliable=tele_mid_unreliable, 
                          tele_top_scored=tele_top_scored, tele_top_missed=tele_top_missed, tele_top_unreliable=tele_top_unreliable, link = link, dock=dock, park=park, win=win, coop_bonus=coop_bonus, sus_bonus=sus_bonus, act_bonus=act_bonus, notes=notes)
        ...
        with open(r'website/static/data.csv', 'w') as s_key:
            ...
            # Horizontal labels
            csv_out.writerow(["Team", "Round", "Alliance", "Starting_pos", "Taxi", "A_Upper_In", "A_Upper_Missed", "A_Upper_Unreliable", "A_Lower_In", "A_Lower_Missed",
                             "A_Lower_Unreliable", "T_Upper_In", "T_Upper_Missed", "T_Upper_Unreliable", "T_Lower_In", "T_Lower_Missed", "T_Lower_Unreliable", "Hang", "Cargo", "Hangar", "Notes"])

            # Database data
            data = db.session.query(Scout.team, Scout.round, Scout.alliance, Scout.starting_pos, Scout.taxi, Scout.auton_upper_in, Scout.auton_upper_missed, Scout.auton_upper_unreliable, Scout.auton_lower_in, Scout.auton_lower_missed,
                                    Scout.auton_lower_unreliable, Scout.tele_upper_in, Scout.tele_upper_missed, Scout.tele_upper_unreliable, Scout.tele_lower_in, Scout.tele_lower_missed, Scout.tele_lower_unreliable, Scout.hang, Scout.cargo_bonus, Scout.hangar_bonus, Scout.notes)
